...
source("rasterize_genoscape_polygons.R")
genoscape_out <- rasterize_genoscape_polygons(
  genoscape_file = "../../07.adaptive_analysis/outputs/BANS_AU_polygons_thresh.55_K3.shp",
  out_tif = "../scratch/genoscape_stars/genoscape_stars_rast_AU_K3_threshold4.tif"
)
...
names(ESU_stack) <- paste0("AU", vals)
...
sp.data.clean %>%
  write.csv("../scratch/spatial_predictors/spatial_predictor_data_xy_from_AU_K3_threshold55.csv", row.names = FALSE)
```